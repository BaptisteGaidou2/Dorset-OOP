...
namespace Dorset_OOP_Project
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Application schoolApplication = new Application("path_UserDB.csv", "path_DisciplineDB.csv", "path_ExamDB.csv", "path_ClassroomDB.csv", "path_StudentAttendences.csv", "path_StudentNotes.csv", "path_LastID.csv", "path_StudentInvoices.csv", "path_StudentPayments.csv");
